...
#
#  barbican-api logging configuration
#
# == parameters
#
#  [*verbose*]
...
class barbican::api::logging(
  ...
  # to use barbican::<myparam> first then barbican::api::logging::<myparam>.
  $use_syslog_real = pick($::barbican::api::use_syslog,$use_syslog)
  $use_stderr_real = pick($::barbican::api::use_stderr,$use_stderr)
  $log_facility_real = pick($::barbican::api::log_facility,$log_facility)
  $log_dir_real = pick($::barbican::api::log_dir,$log_dir)
  $verbose_real  = pick($::barbican::api::verbose,$verbose)
  $debug_real = pick($::barbican::api::debug,$debug)
