...
class barbican::wsgi::apache (
  ...
  Package['barbican'] -> Package['httpd']
  Package['barbican'] ~> Service['httpd']
  ...
  $wsgi_file_defaults = {
    ...
    'group'   => 'barbican',
    'mode'    => '0644',
    'require' => [File[$::barbican::params::barbican_wsgi_script_path], Package['barbican']],
  }
  ...
  ::apache::vhost { 'barbican_wsgi_main':
    ...
    wsgi_daemon_process         => 'barbican_main',
    wsgi_daemon_process_options => $wsgi_daemon_process_options_main,
    wsgi_process_group          => 'barbican_main',
